...
client.println(".button3 {background-color: #5e0101;}</style></head>");

            
            // Web Page Heading
            client.println("<body><h1>ESP32 Web Server-Local control</h1>");
            
            // Display current state, and ON/OFF buttons for GPIO 25  
            client.println("<p>BNL - State " + output25State + "</p>");
           ...
           // Display current state, and ON/OFF buttons for GPIO 26  
            client.println("<p>DH - State " + output25State + "</p>");
            ...
            client.println("<p>Roomlamp - State " + output27State + "</p>");
